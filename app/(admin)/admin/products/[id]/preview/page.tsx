        ...
        <div>
          ...
          {product.tamil_name ? (
            <div className="space-y-0.5 mt-1">
              <h1 className="font-tamil text-2xl md:text-3xl font-semibold text-forest leading-tight">{product.tamil_name}</h1>
              <p className="font-serif text-2xl md:text-3xl font-normal text-ink leading-tight">{product.name}</p>
            </div>
          ) : (
            <h1 className="font-serif text-2xl md:text-3xl font-normal text-forest leading-tight mt-1">{product.name}</h1>
          )}
