...
export function createSeed(): Database {
  ...
  const productSeeds: PSeed[] = [
    {
      ...
      variants: [
        { title: "250 g", sku: "UO-HON-250", grams: 250, price: 34900, compare: 39900 },
        { title: "500 g", sku: "UO-HON-500", grams: 500, price: 64900, compare: 74900 },
        { title: "1 kg", sku: "UO-HON-1000", grams: 1000, price: 119900, compare: 139900 },
      ],
    ...
    },
    {
      ...
      variants: [
        { title: "500 ml", sku: "UO-OIL-500", grams: 460, price: 28900, compare: 32900 },
        { title: "1 L", sku: "UO-OIL-1000", grams: 920, price: 52900, compare: 59900 },
      ],
    ...
    },
    {
      ...
      variants: [
        { title: "100 g", sku: "UO-TUR-100", grams: 100, price: 12900 },
        { title: "250 g", sku: "UO-TUR-250", grams: 250, price: 24900, compare: 27900 },
      ],
    ...
    },
    {
      ...
      variants: [
        { title: "100 g", sku: "UO-PEP-100", grams: 100, price: 18900 },
        { title: "250 g", sku: "UO-PEP-250", grams: 250, price: 42900 },
      ],
    ...
    },
    {
      ...
      variants: [
        { title: "500 g", sku: "UO-FOX-500", grams: 500, price: 14900 },
        { title: "1 kg", sku: "UO-FOX-1000", grams: 1000, price: 27900 },
      ],
    ...
    },
    {
      ...
      tags: ["tag-vegan", "tag-gf", "tag-organic", "tag-trad", "tag-farmer"],
      variants: [
        { title: "500 g", sku: "UO-LIT-500", grams: 500, price: 15900 },
        { title: "1 kg", sku: "UO-LIT-1000", grams: 1000, price: 29900 },
      ],
    ...
    },
    {
      ...
      variants: [
        { title: "250 g", sku: "UO-CAS-250", grams: 250, price: 42900, compare: 47900 },
        { title: "500 g", sku: "UO-CAS-500", grams: 500, price: 79900, compare: 89900 },
      ],
    ...
    },
    {
      ...
      tags: ["tag-vegan", "tag-gf", "tag-nf"],
      variants: [
        { title: "250 g", sku: "UO-ALM-250", grams: 250, price: 44900 },
        { title: "500 g", sku: "UO-ALM-500", grams: 500, price: 84900, compare: 94900 },
      ],
    ...
    },
    {
      ...
      variants: [
        { title: "50 g", sku: "UO-TEA-050", grams: 50, price: 24900 },
        { title: "100 g", sku: "UO-TEA-100", grams: 100, price: 44900 },
      ],
    ...
    },
    {
      ...
      tags: ["tag-vegan", "tag-gf"],
      variants: [
        { title: "500 g", sku: "UO-JAG-500", grams: 500, price: 17900 },
        { title: "1 kg", sku: "UO-JAG-1000", grams: 1000, price: 32900, compare: 36900 },
      ],
    ...
    },
    {
      ...
      tags: ["tag-vegan", "tag-gf", "tag-organic", "tag-trad", "tag-farmer"],
      variants: [
        { title: "1 kg", sku: "UO-RIC-1000", grams: 1000, price: 18900 },
        { title: "5 kg", sku: "UO-RIC-5000", grams: 5000, price: 84900, compare: 94900 },
      ],
    ...
    },
    {
      ...
      tags: ["tag-vegan", "tag-gf"],
      variants: [
        { title: "500 g", sku: "UO-RAG-500", grams: 500, price: 9900 },
        { title: "1 kg", sku: "UO-RAG-1000", grams: 1000, price: 17900 },
      ],
    ...
    },
    {
      ...
      tags: ["tag-vegan", "tag-gf"],
      variants: [
        { title: "250 ml", sku: "UO-SES-250", grams: 230, price: 24900 },
        { title: "500 ml", sku: "UO-SES-500", grams: 460, price: 44900 },
      ],
      nutrition: { serving: "10 ml", energy: 88, protein: 0, carbs: 0, fat: 10, fiber: 0, sugar: 0 },
    },
  ];
  ...
  return {
    ...
    faqs: [
      { id: "faq-1", question: "Do you ship across India?", answer: "Yes, we ship across all states and union territories in India. Orders are dispatched within 1-2 business days with standard delivery in 4-7 days.", position: 1, published: true },
      { id: "faq-2", question: "How do I pay for my order?", answer: "We support UPI, Net Banking, credit/debit cards, and payment links. You can also place orders for direct confirmation with our team.", position: 2, published: true },
      { id: "faq-3", question: "Are prices inclusive of tax?", answer: "Yes, all listed prices are inclusive of applicable GST. Tax invoices are generated automatically with our official GSTIN and FSSAI numbers.", position: 3, published: true },
      { id: "faq-4", question: "Can I return opened food?", answer: "For health and safety standards, opened food packages cannot be returned unless damaged or spoiled in transit. Contact us within 48 hours for immediate assistance.", position: 4, published: true },
    ],
    pages: [
      {
        id: "pg-privacy",
      ...
      },
      {
        ...
        body: "We currently ship across India.\n\nProcessing time\nOrders are processed within 1-2 business days of payment confirmation.\n\nDelivery time\nTypical delivery times are 3-6 business days depending on your pin code. Remote areas may take longer.\n\nShipping charges\nShipping is free on orders above Rs. 999. A flat shipping fee applies to orders below this threshold. The exact shipping charge is calculated and shown at checkout.\n\nTracking\nOnce your order is dispatched, you will receive a tracking AWB number via email and you can track your shipment anytime on our Order Tracking page.\n\nDamaged or missing items\nIf your order arrives damaged or items are missing, please notify us within 48 hours of delivery with a photo of the package for an immediate replacement or full refund.",
        published: true,
      },
      {
        id: "pg-refunds",
        ...
        body: "We want you to be completely satisfied with your purchase.\n\nReturn eligibility\nWe accept returns within 7 days of delivery for unopened, undamaged products in their original packaging.\n\nFood safety\nFor health and safety standards, we cannot accept returns of opened food products unless they are defective or spoiled upon arrival.\n\nHow to return\nContact us at the email on our Contact page with your order number and the reason for the return. We will arrange pickup if the return is approved.\n\nRefund process\nApproved refunds are processed within 5-7 business days of us receiving the returned item. Refunds are credited to the original payment method.",
        published: true,
      },
      {
        id: "pg-cancellation",
        slug: "cancellation",
        title: "Cancellation & Damaged Package Policy",
        body: "Order Cancellation\nYou may cancel your order at any time before it has been dispatched from our facility. To cancel, visit your account order history or contact our support team with your order number.\n\nOnce an order has been dispatched, cancellation is no longer possible, but you may request a return upon delivery in accordance with our Return Policy.\n\nDamaged or Tampered Packages\nIf your package arrives damaged, leaking, or visibly tampered with:\n1. Please take clear photographs of the damaged package and items.\n2. Contact our support team via email or WhatsApp within 48 hours of delivery.\n3. We will immediately dispatch a free replacement or initiate a full refund as preferred.\n\nPayment Failures\nIf amount is debited from your account during an online payment attempt that fails, the banking partner will automatically refund the transaction within 3 to 5 business days.",
        published: true,
      },
    ],
    reviews: [],
    ...
    batches: [
      {
        id: "batch-1",
        batch_number: "HON-2026-B01",
        product_id: "prod-honey",
        harvest_date: "2026-01-15",
        packaging_date: "2026-01-20",
        expiry_date: "2027-01-20",
        initial_quantity: 100,
        remaining_quantity: 85,
        notes: "Western Ghats forest honey. Tested zero added sugar.",
        created_at: T,
        updated_at: T,
      },
      {
        id: "batch-2",
        batch_number: "MIL-2026-B01",
        product_id: "prod-foxtail",
        harvest_date: "2025-11-10",
        packaging_date: "2025-12-05",
        expiry_date: "2026-06-05",
        initial_quantity: 200,
        remaining_quantity: 140,
        notes: "Dharmapuri unpolished foxtail millet.",
        created_at: T,
        updated_at: T,
      },
    ],
