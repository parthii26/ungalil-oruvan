      ...
      >
        <div className="container-page">
          <div className="flex h-16 items-center justify-between gap-4 md:h-[4.5rem]">
            ...
            >
              <span className={`block font-tamil text-[1.25rem] sm:text-[1.35rem] font-bold tracking-tight leading-none truncate md:text-[1.65rem] ${overHero ? "text-cream" : "text-forest"}`}>
                {tamilTagline}
              </span>
              <span className={`block font-serif text-[0.7rem] sm:text-[0.75rem] tracking-[0.14em] uppercase leading-none mt-1 ${overHero ? "text-turmeric" : "text-terracotta"}`}>
                {brand}
              </span>
            </Link>
